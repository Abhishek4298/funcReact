				...
				<div className="row">
					<div className="col-md-3 col-sm-6 item">
						<div className="card item-card card-block">
							<h4 className="item-card-title text-right"><i className="material-icons">12 Red Carnations
</i></h4>
					...
					<div className="col-md-3 col-sm-6 item">
						<div className="card item-card card-block">
							<h4 className="item-card-title text-right"><i className="material-icons">Floral salute</i></h4>
					...
					<div className="col-md-3 col-sm-6 item">
						<div className="card item-card card-block">
							<h4 className="item-card-title text-right"><i className="material-icons">My Bountiful Lady</i></h4>
					...
					<div className="col-md-3 col-sm-6 item">
						<div className="card item-card card-block">
							<h4 className="item-card-title text-right"><i className="material-icons">Joyful Baskets Love</i></h4>
					...
					<div className="col-md-3 col-sm-6 item">
						<div className="card item-card card-block">
							<h4 className="item-card-title text-right"><i className="material-icons">Floral salute</i></h4>
							<img src="https://d1whpkioiz600t.cloudfront.net/Images/product/pw-white-carnation-blue-orchid-bouquet.jpg" alt="flowerImage" />
					...
					<div className="col-md-3 col-sm-6 item">
						<div className="card item-card card-block">
							<h4 className="item-card-title text-right"><i className="material-icons">Send Gift-Be Mine For Ever
</i></h4>
					...
					<div className="col-md-3 col-sm-6 item">
						<div className="card item-card card-block">
							<h4 className="item-card-title text-right"><i className="material-icons">Ferrero Fever
</i></h4>
							<img src="https://d1whpkioiz600t.cloudfront.net/Images/product/pw-blackforestcake-teddy-basket-redroses.jpg" alt="flowerImage" />
					...
					<div className="col-md-3 col-sm-6 item">
						<div className="card item-card card-block">
							<h4 className="item-card-title text-right"><i className="material-icons">Yellow Roses with Kaju Sweets
</i></h4>
